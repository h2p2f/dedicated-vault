...
// Login provides a mock function with given fields: ctx, user, clientID
func (_m *UserHandler) Login(ctx context.Context, user models.User, clientID string) (string, error) {
	ret := _m.Called(ctx, user, clientID)

	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, models.User, string) (string, error)); ok {
		return rf(ctx, user, clientID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, models.User, string) string); ok {
		r0 = rf(ctx, user, clientID)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, models.User, string) error); ok {
		r1 = rf(ctx, user, clientID)
	} else {
		r1 = ret.Error(1)
	}
...
// Register provides a mock function with given fields: ctx, user, clientID
func (_m *UserHandler) Register(ctx context.Context, user models.User, clientID string) (string, error) {
	ret := _m.Called(ctx, user, clientID)
